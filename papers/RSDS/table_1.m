...
%   precomputed/kth-tips/roto_trans_scatt_all.mat
...
if (use_precompted_scattering)
    ...
    % remove margin and globaly average accross position
...
if (use_precompted_scattering)
    ...
    % compute scattering of all images in the database
    % CAN BE SKIPED by loading precomputed/kth-tips/trans_scatt.mat
