% renorm_sibling_2d : renormalize scattering 2d
% Usage
...
%
% Description
%   renorm_sibling_2d will apply op to all the sibling 3d matrix and 
...
function [Sx_renorm, sibling] = renorm_sibling_2d(Sx, op)
