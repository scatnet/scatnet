...
%          options.w: Add weights to rebalance the training set if it is
%             imbalanced. The rebalancing is done so that the distribution
%          of the training samples seem to be uniform for all the classes
%          (default 0).
%
%
% Output
...
% See also SVM_TEST, CLASSiF_ERR, CLASSIF_RECOG
