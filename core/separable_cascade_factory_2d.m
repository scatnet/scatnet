function cascade = separable_cascade_factory_2d(N, filter_options, scatt_options, M)
	...
	for m = 0:M
		...
		cascade.wavelet{m+1} = @(X)(separable_wavelet_layer_2d(X, ...
			{filters{1}{filt1_ind} filters{2}{filt2_ind}}, scatt_options));
