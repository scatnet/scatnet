...
The \mcode{wavelet_factory_2d} function takes a \mcode{size_in} vector of image size and optional parameters wrapped in an \mcode{filt_opt} and \mcode{scat_opt} structure of options parameters, an integer \mcode{M} which is the maximum scattering order and outputs a cell array of linear operators corresponding to successive wavelet transforms. Its signature  is given by
\begin{lstlisting}
