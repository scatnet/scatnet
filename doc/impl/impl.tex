...
ScatNet is a scientific toolbox for MATLAB, which provides tools for the analysis and classification of digital signals, such as sounds, images or time series. Its core feature relies in the construction of a \emph{scattering network}, i.e. a cascade of complex filter banks alternated with a non-linear operator, namely the complex modulus.
