...
Its core feature relies on the construction of a \emph{scattering network}, i.e. a stack of processing layers of increasing width. Each layer consist in the association of a linear filter bank with a non-linear operator, namely the complex modulus.
