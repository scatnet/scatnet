...
This means that, on a classification point of view, a file is just a physical container of the objects which will be classified. Once the file has been read
from its storage location, all the scatnet software knows about is the object.
...
\begin{itemize}
	...
	\item \mcode{train_opt.gamma}: The regularity constant $\gamma$ used in the case of a Gaussian SVM kernel.
        \item \mcode{train_opt.w}: w is $\in \{0,1\}$. If 1 then some 
...
=======
\end{document}
>>>>>>> c24a078c2450ba10a5e633f6aefdb44f6865a202
