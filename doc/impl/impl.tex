...
For example, for wavelet-based image processing, it is sufficient to write
\begin{lstlisting}
...
\begin{enumerate}
\item \mcode{@wavelet_layer_1d}
\item \mcode{@wavelet_layer_2d}
\item \mcode{@wavelet_layer_3d}
\end{enumerate}
