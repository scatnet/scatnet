...
To create this cascade structure, a factory function, \mcode{wavelet_factory_1d} or \mcode{cascade_factory_2d} is used, which takes as input the signal size, a filter parameter structure, a scattering options structure, and the order of the transform. The scattering transform could be used like the following
\begin{lstlisting}
